...
<head>
	...
	<!-- Favicon -->
	<link rel="icon" type="image/svg" sizes="56x56" href="front_end/assets/images/fav-icon/icon.png">

	<!-- bootstrap CSS -->
	<link rel="stylesheet" href="front_end/assets/css/bootstrap.min.css" type="text/css" media="all">
	<!-- carousel CSS -->
	<link rel="stylesheet" href="front_end/assets/css/owl.carousel.min.css" type="text/css" media="all">
	<!-- animate CSS -->
	<link rel="stylesheet" href="front_end/assets/css/animate.css" type="text/css" media="all">
	<!-- animated-text CSS -->
	<link rel="stylesheet" href="front_end/assets/css/animated-text.css" type="text/css" media="all">
	<!-- font-awesome CSS -->
	<link rel="stylesheet" href="front_end/assets/css/all.min.css" type="text/css" media="all">
	<!-- font-flaticon CSS -->
	<link rel="stylesheet" href="front_end/assets/css/flaticon.css" type="text/css" media="all">
	<!-- theme-default CSS -->
	<link rel="stylesheet" href="front_end/assets/css/theme-default.css" type="text/css" media="all">
	<!-- meanmenu CSS -->
	<link rel="stylesheet" href="front_end/assets/css/meanmenu.min.css" type="text/css" media="all">
	<!-- transitions CSS -->
	<link rel="stylesheet" href="front_end/assets/css/owl.transitions.css" type="text/css" media="all">
	<!-- venobox CSS -->
	<link rel="stylesheet" href="front_end/venobox/venobox.css" type="text/css" media="all">
	<!-- bootstrap icons -->
	<link rel="stylesheet" href="front_end/assets/css/bootstrap-icons.css" type="text/css" media="all">
	<!-- Main Style CSS -->
	<link rel="stylesheet" href="front_end/assets/css/style.css" type="text/css" media="all">
	<!-- responsive CSS -->
	<link rel="stylesheet" href="front_end/assets/css/responsive.css" type="text/css" media="all">	
	<!-- modernizr js -->
	<script src="front_end/assets/js/vendor/modernizr-3.5.0.min.js"></script>
</head>
		...
		<div class="row align-items-center" id="poress-row">
			<div class="col-lg-6 col-md-12">
				<div class="porcess-thumb">
					<img src="front_end/assets/images/home/process-thumb.jpg" alt="">
				</div>
			</div>
			<div class="col-lg-6 col-md-12">
	...
	<div class="container">
		...
		<div class="row">
			<div class="col-lg-4 col-md-6">
				<div class="single-blog-box">
					<div class="single-blog-thumb">
						<img src="front_end/assets/images/home/blog-1.jpg" alt="">
					</div>
			       ...
			       <div class="blog-arthor">
						...
						<div class="blog-button">
							<a href="blog-grid"><i class="bi bi-arrow-right-short"></i></a>
						</div>
					</div>
				</div>
			</div>			
			<div class="col-lg-4 col-md-6">
				<div class="single-blog-box">
					<div class="single-blog-thumb">
						<img src="front_end/assets/images/home/blog-2.jpg" alt="">
					</div>
					<div class="blog-content">
						<a href="blog-details.html">How Every Individual Can Make a Difference</a>
						<p>Competently cultivate worldwide to e-tailers professionally engineer high</p>
					</div>
			       <div class="blog-arthor">
						<div class="blog-author-title">
						...
						<div class="blog-button">
							<a href="blog-grid.html"><i class="bi bi-arrow-right-short"></i></a>
						</div>
					</div>
				</div>
			</div>			
			<div class="col-lg-4 col-md-6">
				<div class="single-blog-box">
					<div class="single-blog-thumb">
						<img src="front_end/assets/images/home/blog-3.jpg" alt="">
					</div>
					<div class="blog-content">
						<a href="blog-details.html">Innovations in Renewable Energy Technology</a>
						<p>Competently cultivate worldwide to e-tailers professionally engineer high</p>
					</div>
			       <div class="blog-arthor">
						<div class="blog-author-title">
...
<!--==================================================-->
	...
	<!-- jquery js -->
	<script src="front_end/assets/js/vendor/jquery-3.6.2.min.js"></script>
	<script src="front_end/assets/js/popper.min.js"></script>
	<!-- bootstrap js -->
	<script src="front_end/assets/js/bootstrap.min.js"></script>
	<!-- carousel js -->
	<script src="front_end/assets/js/owl.carousel.min.js"></script>
	<!-- counterup js -->
	<script src="front_end/assets/js/jquery.counterup.min.js"></script>
	<!-- waypoints js -->
	<script src="front_end/assets/js/waypoints.min.js"></script>
	<!-- wow js -->
	<script src="front_end/assets/js/wow.js"></script>
	<!-- imagesloaded js -->
	<script src="front_end/assets/js/imagesloaded.pkgd.min.js"></script>
	<!-- venobox js -->
	<script src="front_end/venobox/venobox.js"></script>

	<!--  animated-text js -->
	<script src="front_end/assets/js/animated-text.js"></script>
	<!-- venobox min js -->
	<script src="front_end/venobox/venobox.min.js"></script>
	<!-- isotope js -->
	<script src="front_end/assets/js/isotope.pkgd.min.js"></script>
	<!-- jquery meanmenu js -->
	<script src="front_end/assets/js/jquery.meanmenu.js"></script>

	<!-- jquery scrollup js -->
	<script src="front_end/assets/js/jquery.scrollUp.js"></script>
	<!-- theme js -->
	<script src="front_end/assets/js/theme.js"></script>
    <!-- coustom js -->
	<script src="front_end/assets/js/coustom.js"></script>
	<!-- barfiller -->
	<script src="front_end/assets/js/jquery.barfiller.js"></script>
	<!-- barfiller -->
	<script src="front_end/assets/js/vanilla-tilt.min.js"></script>
	<script src="front_end/assets/js/silik-slider.js"></script>
